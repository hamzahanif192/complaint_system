...
<div class="modal fade" id="trackingModal{{ $single->id }}" tabindex="-1" aria-labelledby="trackingModalLabel{{ $single->id }}" aria-hidden="true" style="display:none">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="complaintDetails-wrapper">
          ...
          <div class="row conplain">
            <div class="col-md-3">
              <p><span><b>User Name</b></span><br>{{ $single->full_name }}</p>
            </div>
            <div class="col-md-3">
              <p><span><b>Type</b></span><br>{{ $single->complaint_type }}</p>
            </div>
            <div class="col-md-3">
            ...
            <div class="col-md-12">
              <p><span><b>Message</b></span><br>{{$single->complaint_message}}</p>
            </div>
          </div>
        </div>
        <hr>
